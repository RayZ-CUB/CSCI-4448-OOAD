...
public class Constants {
    ...
    public static final String ENTRANCE_ROOM = "0-1-1";
    public static final String ADVENTURER_WIN = "Adventurers win!";
    public static final String CREATURE_WIN = "Creature win!";
